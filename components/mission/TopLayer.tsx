...
export default function TopLayer() {
  return (
    <div className="w-full flex border-y border-white">
      {/* div1 */}
      <div className="w-[16.666%] border-r border-white h-[200px] py-4 px-4">
        <img
      ...
      {/* div3 */}
      <div className="w-[16.666%] border-r border-white h-[200px] py-10 px-10">
        <img
      ...
      {/* div4 */}
      <div className="w-[33.332%] border-r border-white h-[200px]"></div>

      {/* div5 */}
      <div className="w-[16.666%] h-[200px]">
        <img
